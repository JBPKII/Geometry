...
namespace Geometrias
{
    public class Triangulo
    {
        ...
        public static int SentidoTriangulo(Point3dCollection Terna)
        {
            return SentidoTriangulo(Terna[0], Terna[1], Terna[2]);
        }

        public static bool PuntoEnTriangulo(Point3d PTest, Point3d T1, Point3d T2, Point3d T3)
        {
        ...
        public static bool PuntoEnTriangulo(Point3d PTest, Point3dCollection Terna)
        {
            return PuntoEnTriangulo(PTest, Terna[0], Terna[1], Terna[2]);
        }
    }
}
